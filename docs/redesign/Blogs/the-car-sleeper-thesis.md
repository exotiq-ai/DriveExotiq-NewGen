...
Drive Exotiq is the community front door to the exotiq.rent exotic-car marketplace. The reveal in the film is quiet. No wing, no theater, no color that begs for a second look. A dark sedan idles, then goes, and by the time you understand what you were looking at it is already down the road. That restraint is the entire idea.

Everyone expects the McLaren to be the hero. It is the poster, the noise, the thing people point at from the sidewalk. We put an Audi S8 at the front instead, and we did it on purpose.

## What a sleeper actually is

A sleeper is a car that hides its capability under an ordinary suit. It wears the body of something sensible, the kind of car that turns up in an office parking garage without a single head turning, right until the moment it does not behave like one. The pleasure lives in the gap: the distance between what people assume and what the car will actually do. Nothing about it asks for permission, and nothing about it apologizes.

The supercar works the opposite way. It makes a promise on the sidewalk and then has to keep it. The sleeper makes no promise at all, which means it never owes anyone a performance. It just drives.
...
*Further reading on the car and its heritage: the [Audi S8 platform history](https://en.wikipedia.org/wiki/Audi_S8), Audi's own account of its [quattro circuit-racing years](https://www.audi.com/en/sport/motorsport/motorsport-history/06-quattro-circuit-racing/), and Top Gear's guide to the [Audi 90 quattro IMSA GTO](https://www.topgear.com/car-news/motorsport/audi-90-quattro-imsa-gto-top-gears-guide).*
