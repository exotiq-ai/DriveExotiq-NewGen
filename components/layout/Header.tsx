...
const links = [
  ...
  { label: "The roadbook", href: "/tour" },
  { label: "The garage", href: "/marketplace" },
  ...
  return (
    <>
      ...
      <header
        ...
        data-page={pathname === "/apply" ? "apply" : undefined}
      >
        <Link className="site-brand" href="/" aria-label="driveexotiq home">
          <Emblem className="site-emblem" />
          <span>
            drive<span className="site-brand-light">exotiq</span>
          </span>
        </Link>
        ...
        <div className="site-header-actions">
          <Link className="site-header-cta" href="/apply?interest=drives">
      ...
      >
        <div className="site-menu-top">
          <span className="site-eyebrow">DRIVE EXOTIQ · EXPLORE</span>
          <button
