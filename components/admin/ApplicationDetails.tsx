      ...
      <div className="bg-jet-grey border border-metallic-silver/30 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-metallic-silver mb-1">
                Full Name
              </label>
            ...
            <div>
              ...
              <p className="text-pure-white font-medium text-gulf-blue">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              <label className="block font-medium text-metallic-silver mb-1">
                Submitted
              </label>
