...
export default function SmsPage() {
  return (
    ...
    >
      <p>
        This SMS Policy describes the text messaging programs operated by Exotiq
        Inc., a Delaware C-Corporation, doing business as Drive Exotiq
        (&ldquo;Exotiq,&rdquo; &ldquo;Drive Exotiq,&rdquo; &ldquo;we,&rdquo;
        &ldquo;us,&rdquo; or &ldquo;our&rdquo;). For consumer-facing SMS, the
        brand name &ldquo;Drive Exotiq&rdquo; is used. For operator-facing SMS,
        &ldquo;Exotiq&rdquo; is used. Both are the same legal entity.
      </p>
      <p>
        This policy complies with the Telephone Consumer Protection Act
        (&ldquo;TCPA&rdquo;), 47 U.S.C. Section 227, the Cellular
        Telecommunications Industry Association (&ldquo;CTIA&rdquo;) Messaging
        Principles and Best Practices, applicable FCC regulations, and
      ...
      <p>
        Feature announcements, promotional offers, Founding Member updates,
        event-based marketing, and referral program information.
      </p>
      ...
      <p>
        Consent may be provided by: (a) checking the SMS consent checkbox during
        registration or booking; (b) texting START to our number; (c) providing
        your number through a form with clear disclosure; or (d) documented
        verbal consent.
      </p>
      ...
      <blockquote>
        I consent to receive transactional text messages from Drive Exotiq at
        the phone number provided (e.g., booking confirmations, reminders,
        account alerts). Message frequency may vary. Message and data rates may
        apply. Reply HELP for help or STOP to opt out.
      </blockquote>

      <p>Marketing checkbox:</p>
      <blockquote>
        I consent to receive marketing and promotional text messages from Drive
        Exotiq at the phone number provided. Message frequency may vary. Message
        and data rates may apply. Reply HELP for help or STOP to opt out.
      </blockquote>

      <h3>Section 2.3. Not Required for Service</h3>
      <p>
        Consent is not required as a condition of purchasing any goods or
        services, booking a vehicle, or creating an account. Checkboxes are
        never pre-checked.
      </p>

      <h2>Article III: Message Frequency and Rates</h2>
      <p>
        Transactional: 1–5 messages per booking/event. Marketing: no more than 8
        per month. Message and data rates may apply.
      </p>
      ...
      <p>
        Supported by all major U.S. carriers (AT&amp;T, Verizon, T-Mobile,
        others). Carriers are not liable for delayed or undelivered messages.
