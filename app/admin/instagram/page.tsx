    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-metallic-silver mt-1">
            Manage posts displayed on your homepage
          </p>
        </div>
      ...
      <Card className="bg-jet-grey border-gulf-blue/30">
        ...
        <form onSubmit={handleAddPost} className="space-y-4">
          ...
          <Button
            type="submit"
            variant="primary"
            disabled={isAdding || !newPostUrl.trim()}
          >
              ...
              >
                ...
                {post.image_url ? (
                  ...
                  <div className="aspect-square mb-4 rounded-lg bg-graphite flex items-center justify-center">
                    <svg
                      className="w-16 h-16 text-metallic-silver"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="space-y-2 mb-4">
                  {post.caption && (
                    <p className="text-sm text-metallic-silver line-clamp-2">
                      {post.caption}
                    </p>
                  )}
                  <a
      ...
      <Card className="bg-midnight-blue/30 border-gulf-blue/20">
        ...
        <ul className="space-y-2 text-sm text-metallic-silver">
          <li>
            • Copy any Instagram post or reel URL from your @driveexotiq account
          </li>
          ...
          <li>
            • Posts are displayed in the order you add them (newest first)
          </li>
        </ul>
      </Card>
    </div>
